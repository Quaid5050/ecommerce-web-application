                ...
                <div className="col-2 col-sm-3 col-md-3 col-lg-8">
                    ...
                    <nav className="grid__item" id="AccessibleNav">
                        ...
                        <ul id="siteNav" className="site-nav medium center hidearrow">
                                    ...
                                    <ul className="grid grid--uniform mmWrapper">
                                        <li className="grid__item lvl-1 col-md-3 col-lg-3">
                                            ...
                                            <ul className="subLinks">
                                                ...
                                                <li className="lvl-2">
                                                    <a href="shop-grid-5.html" className="site-nav lvl-2">
                                                        5 items per row
                                                    </a>
                                                </li>
                                                <li className="lvl-2">
                                                    <a href="shop-grid-6.html" className="site-nav lvl-2">
                                                        6 items per row
                                                    </a>
                                                </li>
                                                <li className="lvl-2">
                                                    <a href="shop-grid-7.html" className="site-nav lvl-2">
                                                        7 items per row
                                                    </a>
                                                </li>
                                                <li className="lvl-2">
                            ...
                            <li className="lvl1 parent megamenu">
                                <a href="#">
                                    Product <i className="anm anm-angle-down-l" />
                                </a>
                            ...
                            <li className="lvl1 parent dropdown">
                                <a href="#">
                                    Pages <i className="anm anm-angle-down-l" />
                                </a>
                                <ul className="dropdown">
                                    <li>
                                        <a href="cart-variant1.html" className="site-nav">
                                            Cart Page <i className="anm anm-angle-right-l" />
                                        </a>
                                        <ul className="dropdown">
                                            <li>
                                                <a href="cart-variant1.html" className="site-nav">
                                    ...
                                    <li>
                                        <a href="compare-variant1.html" className="site-nav">
                                            Compare Product <i className="anm anm-angle-right-l" />
                                        </a>
                                        <ul className="dropdown">
                                            <li>
                                                <a href="compare-variant1.html" className="site-nav">
                            ...
                            <li className="lvl1 parent dropdown">
                                <a href="#">
                                    Blog <i className="anm anm-angle-down-l" />
                                </a>
                                <ul className="dropdown">
                                    <li>
                            ...
                            <li className="lvl1">
                                <a href="#">
                                    <b>Buy Now!</b> <i className="anm anm-angle-down-l" />
                                </a>
                            </li>
                        </ul>
                    </nav>
