            ...
            <div id="MainContent" className="main-content" role="main">
                ...
                <div className="bredcrumbWrap">
                    <div className="container-fluid breadcrumbs">
                        <Link href="/front" title="Back to the home page">
                            Home
                        </Link>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div className="product-single__meta">
                                        <h1 className="product-single__title">Product Layout Style3</h1>
                                            ...
                                            >
                                                <div className="product-form__item">
                                                    ...
                                                    >
                                                        ...
                                                        />
                                                        <label
                                                            className="swatchLbl color small flat rounded"
                        ...
                        Email
                                        ...
                                        <div className="product-info">
                                            ...
                                            <p className="product-cat">
                                                ...
                                                <a href="http://annimexweb.com/collections/women" title="">
                                                    Women
                                                </a>{" "}
                                            </p>
                                        </div>
                                ...
                                <div className="prFeatures">
                                    <div className="row">
                                        ...
                                        <div className="feature">
                                            ...
                                            />
                                            <div className="details">
                                                <h5>Worldwide Delivery</h5>FREE &amp; fast shipping to over
                                        ...
                                        <div className="feature">
                                            ...
                                            />
                                            <div className="details">
                                                <h5>Hotline</h5>Talk to help line for your question on 4141
                                            ...
                                            <div className="mini-list-item">
                                                <div className="mini-view_image">
                                                    ...
                                                    <a className="grid-view-item__link" href="#">
                                                        <img
                                                            className="grid-view-item__image"
                                                            src="/assets/images/product-images/product-image42.jpg"
                                                            alt=""
                                                        />
                                                    </a>{" "}
                                                </div>
                                            ...
                                            <div className="mini-list-item">
                                                <div className="mini-view_image">
                                                    ...
                                                    <a className="grid-view-item__link" href="#">
                                                        <img
                                                            className="grid-view-item__image"
                                                            src="/assets/images/product-images/product-image40.jpg"
                                                            alt=""
                                                        />
                                                    </a>{" "}
                                                </div>
                                            ...
                                            <div className="mini-list-item">
                                                <div className="mini-view_image">
                                                    ...
                                                    <a className="grid-view-item__link" href="#">
                                                        <img
                                                            className="grid-view-item__image"
                                                            src="/assets/images/product-images/product-image46.jpg"
                                                            alt=""
                                                        />
                                                    </a>{" "}
                                                </div>
                                            ...
                                            <div className="mini-list-item">
                                                <div className="mini-view_image">
                                                    <a className="grid-view-item__link" href="#">
                                                        <img
                                                            className="grid-view-item__image"
                                                            src="/assets/images/product-images/product-image45.jpg"
                                                            alt=""
                                                        />
                                                    </a>{" "}
                                                </div>
                                            ...
                                            <div className="mini-list-item">
                                                <div className="mini-view_image">
                                                    <a className="grid-view-item__link" href="#">
                                                        <img
                                                            className="grid-view-item__image"
                                                            src="/assets/images/product-images/product-image44.jpg"
                                                            alt=""
                                                        />
                                                    </a>{" "}
                                                </div>
